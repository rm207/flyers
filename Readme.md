...
1. We combined all of the searchhelp_x.html files into one file and then we use a bat file to copy the contents of the index.html/mainmenu.html into all of the searchhelp_*.html pages. If you make changes to mainmenu.html, run the bat file to copy its contents programmatically.
